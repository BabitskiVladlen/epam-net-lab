...
namespace BLL.Service {
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="Service.IToDoManager")]
    public interface IToDoManager {
        ...
        BLL.Service.ToDoItem[] GetTodoList(int userId);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IToDoManager/GetTodoList", ReplyAction="http://tempuri.org/IToDoManager/GetTodoListResponse")]
        System.Threading.Tasks.Task<BLL.Service.ToDoItem[]> GetTodoListAsync(int userId);
        ...
        void UpdateToDoItem(BLL.Service.ToDoItem todo);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IToDoManager/UpdateToDoItem", ReplyAction="http://tempuri.org/IToDoManager/UpdateToDoItemResponse")]
        System.Threading.Tasks.Task UpdateToDoItemAsync(BLL.Service.ToDoItem todo);
        ...
        void CreateToDoItem(BLL.Service.ToDoItem todo);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IToDoManager/CreateToDoItem", ReplyAction="http://tempuri.org/IToDoManager/CreateToDoItemResponse")]
        System.Threading.Tasks.Task CreateToDoItemAsync(BLL.Service.ToDoItem todo);
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IToDoManagerChannel : BLL.Service.IToDoManager, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ToDoManagerClient : System.ServiceModel.ClientBase<BLL.Service.IToDoManager>, BLL.Service.IToDoManager {
        ...
        public BLL.Service.ToDoItem[] GetTodoList(int userId) {
            return base.Channel.GetTodoList(userId);
        }
        
        public System.Threading.Tasks.Task<BLL.Service.ToDoItem[]> GetTodoListAsync(int userId) {
            return base.Channel.GetTodoListAsync(userId);
        }
        
        public void UpdateToDoItem(BLL.Service.ToDoItem todo) {
            base.Channel.UpdateToDoItem(todo);
        }
        
        public System.Threading.Tasks.Task UpdateToDoItemAsync(BLL.Service.ToDoItem todo) {
            return base.Channel.UpdateToDoItemAsync(todo);
        }
        
        public void CreateToDoItem(BLL.Service.ToDoItem todo) {
            base.Channel.CreateToDoItem(todo);
        }
        
        public System.Threading.Tasks.Task CreateToDoItemAsync(BLL.Service.ToDoItem todo) {
